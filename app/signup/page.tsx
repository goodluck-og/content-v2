  ...
  return (
    <div className="min-h-screen bg-ink flex items-center justify-center px-4">
      <div className="w-full max-w-sm bg-teal/20 rounded-card p-6">
        ...
        <p className="text-cream/60 text-sm mb-6">Get started with Content Autopilot</p>
        ...
        <p className="text-[11px] text-cream/40 mb-4 text-center">
          Google sign-in is currently limited to approved tester emails until Google verification is complete.
        </p>
